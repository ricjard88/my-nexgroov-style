  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container max-w-2xl mx-auto px-4 py-12 md:py-20">
        ...
        <div className="space-y-10 text-lg text-muted-foreground font-sans leading-[1.75]">
          <p>
            I didn't start at the top nor with any accolades or big names behind my existence. I come from <span className="font-semibold text-foreground">proud hard working people</span> who moved a lot to ensure I could have the opportunity to see beyond what they knew. <span className="font-semibold text-foreground">My mother was a teacher</span> who laid a strict foundation for both the appreciation and focus required to learn something. My first job, I <span className="font-semibold text-foreground">started in the dirt</span>. Raking, mowing, mulching, planting and getting berated (for my own good lol) by <span className="font-semibold text-foreground">oldschool business guys</span>. Who taught me about such things like looking a man in his eye, shaking hands, working hard, not asking questions but getting it done. Needless to say I had a lot of training at an early age thanks to a mom who wanted her son to learn from all the people she could find who did great things.
          ...
          <div className="relative py-6 my-12">
            <div className="absolute left-0 top-0 bottom-0 w-1 bg-accent-warm/20 rounded-full" />
            <p className="pl-8 italic text-2xl text-muted-foreground font-light leading-snug tracking-tight font-serif">
          ...
          <p>I also on the <span className="font-semibold text-foreground">rare occasion</span> will work with leaders to solve problems that are strange enough to stretch the imagination and demand genuine growth.</p>
          ...
          <p className="text-foreground font-semibold">Forward Ever.</p>
        </div>
