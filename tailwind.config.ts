  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        // Fast, visible animations
        "tile-rotate": "tile-rotate 1.5s linear infinite",
        "tile-rotate-fast": "tile-rotate 0.8s linear infinite",
        "tile-scale": "tile-scale 1.2s ease-in-out infinite",
        "tile-scale-fast": "tile-scale 0.7s ease-in-out infinite",
        "tile-glow": "tile-glow 1.5s ease-in-out infinite",
        "tile-glow-fast": "tile-glow 0.8s ease-in-out infinite",
        "tile-drift": "tile-drift 1.5s ease-in-out infinite",
        "tile-drift-fast": "tile-drift 0.8s ease-in-out infinite",
        "tile-sway": "tile-sway 1.2s ease-in-out infinite",
        "tile-sway-fast": "tile-sway 0.7s ease-in-out infinite",
        "tile-breathe": "tile-breathe 1.5s ease-in-out infinite",
        "tile-breathe-fast": "tile-breathe 0.8s ease-in-out infinite",
      },
    },
  },
